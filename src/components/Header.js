    ...
    render() {
        return (
            <React.Fragment>
                        ...
                        <div className="row justify-content-center">
                            <div className="col-sm-10 px-2 py-3 d-flex justify-content-around  align-items-center hd-text-hdlr">
                                <span className="text-center header-text">
                                    <Link className="text-center text-light" href="/" >
                                        <i className="fa fa-heartbeat hdr-icon-link text-danger"></i>
                                    </Link>
                                </span>
                                <h1 className="mb-0 text-center text-primary header-text">Host a Healthcare Hero</h1>
                                <span className="text-center header-text">
                                    <Link className="text-center text-light" href="/" >
                                        <i className="fa fa-heartbeat hdr-icon-link text-danger"></i>
                                    </Link>
                ...
                <Navbar className="navbar navbar-expand-lg d-flex justify-content-end sticky-top text-light bg-primary myNav">
                    <div className="container justify-content-between">
                        <NavbarBrand>
                            <i class="fa fa-heartbeat text-danger text-lg nav-logo" />
                        </NavbarBrand>
                        <NavbarToggler onClick={this.toggleNav} className="justify-content-end">
                            <i className="fa fa-bars fa-lg text-danger nv-icon "/> 
                        </NavbarToggler>
                        <Collapse isOpen={this.state.isNavOpen} navbar className="justify-content-end">
                            <Nav navbar className="ml-auto text-center text-light nav-text">
                                <NavItem className="nav-item">
                                    <NavLink onClick={this.closeNav} className="nav-link" to="/"> 
                                        Home
                                    </NavLink>
                                </NavItem>
                                <NavItem>
